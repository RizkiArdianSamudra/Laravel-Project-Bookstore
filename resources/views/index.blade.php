...
<div class="min-h-screen">
    <div class="grid grid-cols-2 gap-10 px-32 h-[65vh] bg-[url('images/banner-bg.jpg')]">
        <div class="flex items-center">
            <div>
                <h1 class=" text-5xl font-bold">Toko Buku Nusantara</h1>
                <p class="mt-5 text-lg"></p>
                <div class="mt-5 px-8 py-3 rounded-lg bg-[#27ae60] text-xl text-white font-medium w-fit">
        ...
        <div class="flex items-end">
            <div>
                <div class="flex justify-center">
                    <img src="{{ url('images/book-1.png') }}" class="w-48">
                    <img src="{{ url('images/book-2.png') }}" class="w-48">
                    <img src="{{ url('images/book-3.png') }}" class="w-48">
                </div>
                <div>
